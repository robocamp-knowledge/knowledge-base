...
![Bird nest robot built by RoboCamp from LEGO Education Science bricks](science-bird-nest.jpg){: .content--align-right style="max-width: 50%; margin: 20px 0px;"}
...
Skąd takie wnioski? [Czy opłaca się kupić LEGO Science](#cena-i-opacalnosc-lego-science)? [Czy ten zestaw będzie najlepszy dla Ciebie?](#wnioski-czy-lego-science-jest-dla-ciebie)
...
![LEGO Science box with elements inside](science-box-open.jpg){: .content--align-right style="max-width: 100%; margin: 20px 0px;"}
...
LEGO gwarantuje też dostęp do obszernego Teacher Portal z materiałami dydaktycznymi dla nauczyciela, które są kompatybilne z trzema zestawami z serii Science. [Więcej o materiałach piszemy poniżej](#praca-z-zestawem-i-materiay-dydaktyczne).
...
W zestawach **jest mało elementów czysto mechanicznych**: kół, zębatek, czy listew zębatych. W praktyce, ta decyzja wyraźnie utrudnia (czasem uniemożliwia) prezentowanie i wyjaśnienie uczniom zagadnień mechanicznych wychodzących poza absolutne podstawy. Ma to bezpośredni wpływ na [możliwości korzystania z zestawu](#mozliwosci-zestawu).
...
![Bird nest – 4 robots made by RoboCamp from different LEGO Education sets](science-bird-nest-4-robots.jpg){: .content--align-right style="max-width: 100%; margin: 20px 0px;"}
...
**Jednak elementy elektroniczne z serii Science są programowalne przez [aplikację Coding Canvas](#aplikacja-coding-canvas)**, która umożliwia tworzenie programów przy pomocy bloczków kodu, na wzór Bloków słów. Elektronikę łączymy bezprzewodowo przez Bluetooth.
Brak kabli przy elektronice i możliwość pracy offline tworzy ciekawe nowe możliwości dla konstruktorów LEGO i hobbystów – chociaż seria Science nie została zaprojektowana dla nich.
...
> **Czy lekcje dla wszystkich grup możemy realizować przy pomocy zestawu dla najstarszej grupy wiekowej?** <br> Nie. Aby zapobiec tego typu praktykom, LEGO zadbało by klocki konstrukcyjne w każdym zestawie były inne. Wszystkie zestawy mają podobny zbiór części podstawowych, ale każdy zestaw ma kilka unikalnych elementów potrzebnych do zrealizowania lekcji z Teacher Portal.
...
![LEGO Education Science electronic elements](science-electronics.jpg){: .content--align-right style="max-width: 100%; margin: 20px 0px;"}
...
Precyzyjny kontroler z dwiema dźwigniami sterowania wychylnymi o +- 90 stopni i rozdzielczością rejestrowania co 0,25 stopnia.
Czas pełnego ładowania ok. 45 minut.
...
![LEGO Education Connect cards](science-connect-cards.jpg){: .content--align-right style="max-width: 100%; margin: 20px 0px;"}
...
Producent podkreśla również wielorazowy charakter zestawów. Mają nie wymagać uzupełniania, być zawsze gotowe do użycia. Jednak każdy kto pracował z klockami dydaktycznymi wie, że elementy łatwo się gubią i mieszają między zestawami – żaden zestaw klocków nie jest wolny od tego problemu. Co więcej, elektronikę trzeba regularnie ładować, a w przypadku LEGO Science [jest to dość uciążliwie](#multi-adowarka-45623).
...
>[...] wyzwania zgłaszane przez nauczycieli podczas wdrażania miały przede wszystkim charakter dydaktyczny: zarządzanie czasem, uzupełnianie luk wiedzy oraz wspieranie transferu pojęć. [...] dwie trzecie nauczycieli było w stanie zrealizować lekcje w blokach 45–60 minut, część zdecydowała się je wydłużyć. <br> – [LEGO® Education Science Case Study](https://education.lego.com/en-us/resources/les-case-study-download/){:rel=“nofollow” target="_blank"}: Enhancing Engagement in Science among Diverse Learners
...
![Printed building instructions for LEGO Education Science](science-box-instructions.jpg){: .content--align-right style="max-width: 100%; margin: 20px 0px;"}
...
- [Kurs programowania SPIKE Prime dla średniozaawansowanych](/pl/course-spike-prime-intermediate/){:target="_blank"}
- [Kurs programowania SPIKE Essential dla początkujących](/pl/course-spike-essential-early-learners/){:target="_blank"}

Materiały do lekcji od producenta dostępne są na specjalnie przygotowanej platformie dydaktycznej [Teacher Portal](https://teach.legoeducation.com/pl-pl/science/lessons){:rel=“nofollow” target="_blank"}. Zawierają kilkuslajdowe prezentacje prowadzące uczniów przez proces ćwiczenia oraz proste konspekty i wskazówki dla nauczyciela.
...
![Model for a lesson by LEGO Education for Science kit: Big fish in a little pond](science-lesson-big-fish.jpg){: .content--align-right style="max-width: 100%; margin: 20px 0px;"}
...
[Coding Canvas](https://code.legoeducation.com/en-us/word){:rel=“nofollow” target="_blank"} to aplikacja do programowania elektroniki LEGO Science przy pomocy bloczków kodu. Działa w przeglądarce, na bardzo podobnej zasadzie co Bloki słów z aplikacji SPIKE.
...
- Programy tworzymy przy pomocy bloczków kodu, podobnych do Bloków słów. [Tryb analogiczny do Bloków ikon](https://code.legoeducation.com/en-us/icon){:rel=“nofollow” target="_blank"} też istnieje, ale jest na ten moment tak ograniczony, że praktycznie nieużywalny.
- Aplikacja jest obecnie dostępna wyłącznie w języku angielskim.

![First look at Coding Canvas app for LEGO Education Science](science-coding-canvas.jpg){: .content--align-right style="max-width: 100%; margin: 20px 0px;"}
...
> Uwaga! Gotowe lekcje poruszają większość tematów wymaganych przez NGSS, ale nie wszystkie. Lekcje nie zostały też stworzone pod kątem polskiej podstawy programowej, [ale częściowo się z nią pokrywają](#materiay-dydaktyczne-i-teacher-portal).
...
![Price comparison: LEGO Science vs LEGO SPIKE](science-price-comparison.png){: .content--align-right style="max-width: 100%; margin: 20px 0px;"}
...
Dla szkół, które chcą wdrażać LEGO Education krok po kroku, **Science może być bezpiecznym rozwiązaniem na początek**: najpierw uporządkowane, bezekranowe lekcje, a dopiero potem przejście do SPIKE’a, gdy nauczyciele i uczniowie są gotowi na programowanie i bardziej zaawansowaną pracę inżynierską. W takim ujęciu LEGO Science nie tyle konkuruje ze SPIKE, ile **wprowadza do bogatszych narzędzi STEM i robotyki**, zwłaszcza tam, gdzie ograniczeniem jest dostęp do sprzętu, pewność nauczycieli w pracy z technologią albo czas na przygotowanie zajęć.

W innych szkołach LEGO Science będzie po prostu **„minimum programowym”** – sposobem na zapewnienie uczniom kontaktu z praktycznymi lekcjami STEM zgodnymi ze standardami edukacyjnymi i zajęć bez ekranów, bez gruntownej przebudowy planu lekcji i bez dużych inwestycji w infrastrukturę. Tam, gdzie SPIKE lub BricQ Motion są już obecne, Science najprawdopodobniej pozostanie uzupełnieniem oferty, a nie głównym narzędziem pracy.

Najważniejsze, by widzieć ten zestaw takim, jaki jest naprawdę: **nie jako uniwersalne rozwiązanie do robotyki i programowania, lecz specjalistyczny zestaw do szybkich, gotowych lekcji z elementami STEM i wykorzystaniem klocków LEGO**.
